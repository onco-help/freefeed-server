...
const timelinesPostsTrait = (superClass) =>
  class extends superClass {
    ...
    `,
      ...
      const [{ rows: postsData }, { rows: localBumpsData }] = await Promise.all([
    ...
    async getPostsWithStuffByIds(postsIds, viewerId = null, params = {}) {
      ...
      const postFields = _.without(
        Object.keys(POST_FIELDS),
        'comments_count',
        'likes_count',
        'friendfeed_url',
        'short_id',
