...
describe('PrivateGroups', () => {
  ...
  describe('#admin', () => {
    ...
    beforeEach(async () => {
      ...
      group = await funcTestHelper.createGroupAsync(
        adminContext,
        'pepyatka-dev',
        'Pepyatka Developers',
        true,
  ...
  describe('#sendRequest', () => {
    ...
    beforeEach(async () => {
      ...
      const response = await funcTestHelper.createGroupAsync(
        adminContext,
        'pepyatka-dev',
        'Pepyatka Developers',
        true,
  ...
  describe('Posting to restricted group', () => {
    ...
    beforeEach(async () => {
      ...
      const [group1, group2, group3] = await Promise.all([
        funcTestHelper.createGroupAsync(
          adminContext,
          'pepyatka-dev',
          'Pepyatka Developers',
          true,
